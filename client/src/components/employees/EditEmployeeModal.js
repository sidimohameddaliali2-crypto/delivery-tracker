...
const buildFormData = (employee) => ({
  ...
  vacationAllocatedDays: employee?.leaveBalances?.vacation?.allocatedDays ?? 21,
  publicHolidayAllocatedDays: employee?.leaveBalances?.publicHoliday?.allocatedDays ?? 24,
  sickAllocatedDays: employee?.leaveBalances?.sick?.allocatedDays ?? 10
});
