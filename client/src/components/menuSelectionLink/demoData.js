...
export const DEMO_MEALS = [
  ...
  meal('m3', 0, 'main', 'Grilled lemon chicken', 'Chicken, basmati rice, broccoli · 520 kcal', [], []),
  meal('m4', 0, 'main', 'Baked chicken ziti', 'Chicken, ziti, tomato, mozzarella · 610 kcal', ['Gluten', 'Dairy'], []),
  meal('m5', 0, 'main', 'Ginger soy salmon', 'Salmon, jasmine rice, bok choy · 540 kcal', ['Fish', 'Soy'], []),
  meal('m25', 0, 'main', 'Smoked pork carbonara', 'Pork belly, pancetta, egg yolk, pecorino · 640 kcal', ['Gluten', 'Eggs', 'Dairy'], ['No pork']),
  meal('m26', 0, 'main', 'Braised beef short rib', 'Beef short rib, red wine, mash · 660 kcal', ['Dairy'], ['No beef']),
  meal('m27', 0, 'main', 'Paneer butter masala', 'Paneer, cream, tomato, naan · 580 kcal', ['Dairy', 'Gluten'], ['Vegan', 'Vegetarian']),
  meal('m6', 1, 'breakfast', 'French toast', 'Brioche, cinnamon, berries · 380 kcal', ['Gluten', 'Eggs', 'Dairy'], []),
  meal('m7', 1, 'main', 'Chickpea tagine', 'Chickpea, apricot, couscous · 470 kcal', ['Gluten'], ['Vegan']),
  meal('m8', 1, 'main', 'Herb-crusted cod', 'Cod, sweet potato, spinach · 490 kcal', ['Fish', 'Gluten'], []),
  meal('m9', 1, 'main', 'Lamb kofta', 'Lamb, flatbread, cucumber salad · 580 kcal', ['Gluten'], ['No pork']),
  meal('m10', 2, 'breakfast', 'Greek yoghurt bowl', 'Yoghurt, honey, granola · 300 kcal', ['Dairy', 'Nuts'], []),
  meal('m11', 2, 'main', 'Teriyaki chicken bowl', 'Chicken, rice, edamame · 550 kcal', ['Soy', 'Sesame'], []),
  meal('m12', 2, 'main', 'Mushroom risotto', 'Arborio, porcini, parmesan · 530 kcal', ['Dairy'], ['Vegetarian']),
  meal('m13', 3, 'breakfast', 'Shakshuka', 'Eggs, tomato, pepper, sourdough · 410 kcal', ['Eggs', 'Gluten'], []),
  meal('m14', 3, 'main', 'Turkey meatballs', 'Turkey, orzo, roasted tomato · 560 kcal', ['Eggs', 'Dairy', 'Gluten'], []),
  meal('m15', 3, 'main', 'Thai green curry', 'Chicken, coconut, rice noodles · 570 kcal', ['Fish'], []),
  meal('m16', 4, 'breakfast', 'Protein smoothie bowl', 'Banana, whey, peanut butter · 350 kcal', ['Dairy', 'Peanuts'], []),
  meal('m17', 4, 'main', 'Beef ragù', 'Beef, penne, oregano · 620 kcal', ['Gluten'], ['No beef']),
  meal('m18', 4, 'main', 'Slow-roast harissa chicken', 'Chicken, freekeh, squash · 545 kcal', ['Gluten'], []),
  meal('m19', 5, 'breakfast', 'Overnight oats', 'Oats, almond milk, blueberry · 290 kcal', ['Nuts'], ['Vegan']),
  meal('m20', 5, 'main', 'Mezze bowl', 'Falafel, hummus, tabbouleh · 480 kcal', ['Gluten', 'Sesame'], ['Vegetarian']),
  meal('m21', 5, 'main', 'Sea bass fillet', 'Sea bass, new potato, asparagus · 500 kcal', ['Fish'], []),
  meal('m22', 6, 'breakfast', 'Egg white omelette', 'Egg white, spinach, feta · 260 kcal', ['Eggs', 'Dairy'], []),
  meal('m23', 6, 'main', 'Chili con karne 2.0', 'Beef, black bean, rice · 590 kcal', [], ['No beef']),
  meal('m24', 6, 'main', 'Miso aubergine', 'Aubergine, miso, soba · 460 kcal', ['Soy', 'Gluten', 'Sesame'], ['Vegan']),
];
