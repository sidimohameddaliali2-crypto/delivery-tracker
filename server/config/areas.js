// Area/Zone detection mappings for UAE
const AREA_MAPPINGS = [
  // Dubai Areas
  {
    keywords: [
  ...
  {
    keywords: [
      'al merkadh', 'almerkadh', 'merkadh', 'Mohamed bin Rashid city', 'Mohamedbinrashidcity'
    ],
    area: 'Al Merkadh'
  },
  {
   ...
   {
    keywords: [
      'Rukan 3', 'Rukan', 'Rukan Tower',
    ],
    area: 'Rukan Community'
  },
  ...
  },
  {
    keywords: [
      ...
      'al barsha south two', 'barsha south two', 'Q Gardens Boutique Residences'
    ],
  ...
  {
    keywords: [
      'umm suqaim 3', 'ummsuqaim3', 'umm suqeim 3', 'ummsuqeim3', 'Mjl Lamtara 1,', 'Mjl Lamtara 1', 'Mjl Lamtara',
      'umm suqaim three',
    ],
    area: 'Umm Suqaim 3'
  },
  ...
  },
  {
    keywords: [
      ...
      'oud al muteena one', 'oud al muteena'
    ],
  ...
  {
    keywords: [
      'umm suqaim 2', 'ummsuqaim2', 'umm suqeim 2', 'ummsuqeim2',
      'umm suqaim two', 'Lamtara 1'
    ],
    area: 'Umm Suqaim 2'
  },
  {
  ...
  {
    keywords: [
      'umm suqaim 1', 'ummsuqaim1', 'umm suqeim 1',
      'ummsuqeim1', 'umm suqaim one'
    ],
    area: 'Umm Suqaim 1'
  },
  {
  ...
  {
    keywords: [
      'umm suqaim', 'ummsuqaim', 'umm suqeim'
    ],
    area: 'Umm Suqaim'
  },
  {
  ...
  {
    keywords: [
      'mira 3', 'mira3', 'Mira third', 'mira three'
    ],
    area: 'Mira 3'
  },
  {
  ...
  {
    keywords: [
      'al furjan west', 'alfurjanwest', 'furjan ewest'
    ],
    area: 'Al Furjan West'
  },
  {
  ...
  {
    keywords: [
      'barsha south', 'barshasouth', 'al barsha south', 'Al Barsha South', 'Al Barsha South,', 'Q Gardens Boutique Residences', 'Q GardensBoutiqueResidences',
    ],
    area: 'Barsha South'
  },
  {
  ...
  {
    keywords: [
      'the greens', 'thegreen', 'golf views Tower'
    ],
    area: 'The Greens'
  },
  ...
  {
    keywords: [
      'nad al sheba 1', 'nadalshiba1', 'shiba 1', 'shiba1', 'Azizi riviera', 'Aziziriviera',
      'nad al sheba one', 
    ],
    area: 'Nad Al Sheba 1'
  },
  {
    keywords: [
      'nad al sheba', 'nadalshiba', 'shiba', 'shiba',
      'nad al sheba', 
    ],
    area: 'Nad Al Sheba'
  },
  ...
  },
 {
  ...
  {
    keywords: [
      'dubai studio city', 'dubaistudiocity', 'studio city', 'Laya Heights'
    ],
  ...
  {
    keywords: [
      'dubai silicon oasis', 'dubaisiliconoasis', 'silicon oasis', 'siliconoasis'
    ],
  ...
  {
    keywords: [
      'mira 2', 'mira2', 'mira two', 'mira twice'
    ],
    area: 'Mira 2'
  },
  {
    keywords: [
      'mira 4', 'mira4', 'mira four', 'mira fourth'
    ],
    area: 'Mira 4'
  },
  {
    keywords: [
      'mira 5', 'mira5', 'mira five', 'mira fifth'
    ],
    area: 'Mira 5'
  },
  {
    keywords: [
      'mira oasis 1', 'miraoasis1', 'mira oasis one'
    ],
    area: 'Mira Oasis 1'
  },
  {
    keywords: [
      'mira oasis 2', 'miraoasis2', 'mira oasis two'
    ],
    area: 'Mira Oasis 2'
  },
  {
    keywords: [
      'mira oasis 3', 'miraoasis3', 'mira oasis three'
    ],
    area: 'Mira Oasis 3'
  },
...
function detectAreaFromAddress(address, currentZone = '', options = {}) {
  try {
    if (!address || typeof address !== 'string') {
      return currentZone || '';
    }

    const { company = '', skipAutoCorrect = false } = options;
    const normalizedAddress = address.toLowerCase().trim();

    // Don't auto-correct if:
    // 1. Address contains "Abu Dhabi" 
    // 2. Company is "Swiftbox"
    if (skipAutoCorrect || normalizedAddress.includes('abu dhabi') || company?.toLowerCase().includes('swiftbox')) {
      console.log(`📍 Skipping auto-detection for address: "${address}" (Abu Dhabi address or Swiftbox company)`);
      return currentZone || '';
    }
